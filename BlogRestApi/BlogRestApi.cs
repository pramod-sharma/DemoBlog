...
namespace BlogRestApi
{
    ...
    /// </summary>
    internal sealed class BlogRestApi : StatelessService
    {
        public BlogRestApi(StatelessServiceContext context)
            : base(context)
        { }
        ...
        /// <returns></returns>
        internal static Uri GetBlogDataServiceName(ServiceContext context)
        {
